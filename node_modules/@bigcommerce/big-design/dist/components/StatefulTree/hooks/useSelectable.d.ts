...
export declare const useSelectable: <T extends unknown>({ defaultSelected, disabledNodes, nodes, onSelectionChange, type, }: UseSelectableProps<T>) => {
    selectedNodes: string[];
    onSelect: (nodeId: string, value: T) => void;
};
export {};
