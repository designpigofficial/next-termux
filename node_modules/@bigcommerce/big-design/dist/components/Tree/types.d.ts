...
export declare type TreeSelectableType = 'radio' | 'multi' | undefined;
export declare type TreeOnKeyDown<T> = (e: React.KeyboardEvent<HTMLLIElement>, node: {
    id: TreeNodeId;
    isExpanded: boolean;
...
export declare type TreeOnNodeClick = (e: React.MouseEvent<HTMLLIElement>, nodeId: TreeNodeId) => void;
...
export declare type NodeMap = Map<TreeNodeId, MapValues>;
