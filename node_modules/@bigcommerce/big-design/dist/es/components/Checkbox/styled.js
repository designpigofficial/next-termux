...
export var CheckboxLabelContainer = /*#__PURE__*/styled.div.withConfig({
...
export var CheckboxContainer = /*#__PURE__*/styled.div.withConfig({
...
export var StyledCheckbox = /*#__PURE__*/styled.label.withConfig({
  displayName: "styled__StyledCheckbox",
  componentId: "sc-s1u0st-3"
})(["", " align-items:center;background:", ";border:", ";border-color:", ";border-radius:", ";color:", ";cursor:pointer;display:inline-flex;height:", ";justify-content:center;user-select:none;width:", ";", ";", " ", ":focus + &{box-shadow:", ";}svg{opacity:", ";}"], withTransition(['border-color', 'background', 'box-shadow', 'color', 'opacity']), function (_ref2) {
