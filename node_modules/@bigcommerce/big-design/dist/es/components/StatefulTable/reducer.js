...
function getActivePills(pillTabs, activePills, pillId) {
  ...
  return isToggledPillActive ? [].concat(_toConsumableArray(activePills), [toggledPill.id]) : activePills.filter(function (activeFilter) {
...
function togglePill(items, activePills, filter) {
  return activePills.length > 0 ? activePills.map(function (pillId) {
    ...
    return [].concat(_toConsumableArray(results), _toConsumableArray(dedupedItems));
  }, []) : items;
}
