...
var AlertsManager = /*#__PURE__*/function () {
  function AlertsManager() {
    ...
    (0, _defineProperty2.default)(this, "timeout", {});
  ...
  (0, _createClass2.default)(AlertsManager, [{
    key: "afterEvent",
    value: function afterEvent() {
      this.manageTimeout();
      this.notifySubscribers();
    }
  }, {
    key: "manageTimeout",
    value: function manageTimeout() {
      var _this$alerts$, _this$timeout;

      var alert = (_this$alerts$ = this.alerts[0]) !== null && _this$alerts$ !== void 0 ? _this$alerts$ : null;

      if (((_this$timeout = this.timeout) === null || _this$timeout === void 0 ? void 0 : _this$timeout.key) === (alert === null || alert === void 0 ? void 0 : alert.key)) {
        return;
      }
      ...
      if (alert !== null && alert !== void 0 && alert.autoDismiss) {
    ...
    value: function notifySubscribers() {
      ...
      this.subscribers.forEach(function (subscriber) {
        ...
        return subscriber((_this2$alerts$ = _this2.alerts[0]) !== null && _this2$alerts$ !== void 0 ? _this2$alerts$ : null);
      });
    }
  }, {
    key: "getUniqueId",
