...
var StyleableList = (0, _utils.typedMemo)(function (_ref) {
  ...
  var renderAction = (0, _react.useCallback)(function (action) {
  ...
  var renderItems = (0, _react.useCallback)(function (listItems) {
  ...
  var renderGroup = (0, _react.useCallback)(function (group) {
    return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, group.separated && /*#__PURE__*/_react.default.createElement(_GroupSeparator.ListGroupSeparator, null), group.label && /*#__PURE__*/_react.default.createElement(_GroupHeader.ListGroupHeader, null, group.label), isItemGroup(group) && renderItems(group.items), isOptionGroup(group) && renderItems(group.options));
  }, [renderItems]);
  ...
  return /*#__PURE__*/_react.default.createElement(_styled.StyledList, (0, _extends2.default)({}, getMenuProps(_objectSpread(_objectSpread({}, props), {}, {
...
var List = /*#__PURE__*/(0, _react.memo)(
/*#__PURE__*/
