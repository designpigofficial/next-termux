...
var _excluded = ["chips", "description", "disabled", "error", "forwardedRef", "label", "labelId"],
...
var StyleableInput = function StyleableInput(_ref) {
  ...
  var errors = (0, _react.useMemo)(function () {
    var validateError = function validateError(err) {
      ...
      if ( /*#__PURE__*/(0, _react.isValidElement)(err) && err.type === _Form.FormControlError) {
        return err;
      }
    ...
    if (Array.isArray(error)) {
      var nextError = error.reduce(function (acc, errorItem) {
        ...
        return nextErrorItem ? [].concat((0, _toConsumableArray2.default)(acc), [nextErrorItem]) : acc;
      }, []);
...
var Input = (0, _utils.typedMemo)( /*#__PURE__*/(0, _react.forwardRef)(function (_ref2, ref) {
