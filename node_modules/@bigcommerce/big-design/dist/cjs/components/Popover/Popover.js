...
var _excluded = ["anchorElement", "children", "isOpen", "role"],
    _excluded2 = ["anchorElement", "children", "closeOnClickOutside", "closeOnEscKey", "id", "label", "matchAnchorElementWidth", "skidding", "distance", "onClose", "placement", "role"];
...
var InternalPopover = function InternalPopover(_ref2) {
  ...
  (0, _react.useEffect)(function () {
    ...
    var clickHandler = function clickHandler(event) {
      ...
      if (popperElement !== null && popperElement !== void 0 && popperElement.contains(event.target)) {
        return;
      }

      if (anchorElement !== null && anchorElement !== void 0 && anchorElement.contains(event.target)) {
        return;
      }
  ...
  }, [anchorElement, closeOnClickOutside, onClose, popperElement]); // Setup close on Esc key
