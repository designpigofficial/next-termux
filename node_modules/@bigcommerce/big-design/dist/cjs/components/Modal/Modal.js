...
var Modal = (0, _utils.typedMemo)(function (props) {
...
var InternalModal = function InternalModal(_ref) {
  ...
  var internalTrap = (0, _react.useRef)(null);
  ...
  (0, _react.useEffect)(function () {
    if (modalRef && internalTrap.current === null) {
      internalTrap.current = (0, _focusTrap.default)(modalRef, {
    ...
    return Array.isArray(actions) && /*#__PURE__*/_react.default.createElement(_styled.StyledModalActions, {
      ...
      return /*#__PURE__*/_react.default.createElement(_Button.Button, (0, _extends2.default)({
        ...
        onClick: function onClick(event) {
          var _internalTrap$current2;

          (_internalTrap$current2 = internalTrap.current) === null || _internalTrap$current2 === void 0 ? void 0 : _internalTrap$current2.deactivate();
