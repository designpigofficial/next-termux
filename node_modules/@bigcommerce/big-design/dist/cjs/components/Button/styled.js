...
})(["align-content:center;align-items:center;display:inline-grid;grid-auto-flow:column;grid-gap:", ";visibility:", ";"], function (_ref21) {
  var theme = _ref21.theme;
  return theme.spacing.xSmall;
}, function (_ref22) {
  var isLoading = _ref22.isLoading;
...
var ButtonPrimary = /*#__PURE__*/(0, _styledComponents.css)(["background-color:", ";border-color:", ";font-weight:", ";&:active{background-color:", ";}&:focus{box-shadow:", ";}&:hover:not(:active){background-color:", ";}&[disabled]{background-color:", ";}"], function (_ref23) {
...
var ButtonPrimaryDestructive = /*#__PURE__*/(0, _styledComponents.css)(["background-color:", ";border-color:", ";font-weight:", ";&:active{background-color:", ";}&:focus{box-shadow:", ";}&:hover:not(:active){background-color:", ";}&[disabled]{background-color:", ";}"], function (_ref30) {
...
var ButtonSecondary = /*#__PURE__*/(0, _styledComponents.css)(["background-color:transparent;border-color:", ";color:", ";&:active{background-color:", ";}&:focus{box-shadow:", ";}&:hover:not(:active){background-color:", ";}&[disabled]{color:", ";}"], function (_ref37) {
...
var ButtonSecondaryDestructive = /*#__PURE__*/(0, _styledComponents.css)(["background-color:transparent;border-color:", ";color:", ";&:active{background-color:", ";}&:focus{box-shadow:", ";}&:hover:not(:active){background-color:", ";}&[disabled]{color:", ";}"], function (_ref43) {
...
var ButtonSubtle = /*#__PURE__*/(0, _styledComponents.css)(["background-color:transparent;border-color:transparent;color:", ";&:active{background-color:", ";}&:focus{box-shadow:", ";}&:hover:not(:active){background-color:", ";}&[disabled]{border-color:transparent;color:", ";}"], function (_ref49) {
...
var ButtonSubtleDestructive = /*#__PURE__*/(0, _styledComponents.css)(["background-color:transparent;border-color:transparent;color:", ";&:active{background-color:", ";}&:focus{box-shadow:", ";}&:hover:not(:active){background-color:", ";}&[disabled]{border-color:transparent;color:", ";}"], function (_ref54) {
