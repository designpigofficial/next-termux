...
var emCalc = function emCalc(value) {
  var _themeOptions$getOpti2 = _options.themeOptions.getOptions(),
      htmlFontSize = _themeOptions$getOpti2.htmlFontSize;

  return (0, _polished.em)(value, htmlFontSize);
};

exports.emCalc = emCalc;
var listReset = /*#__PURE__*/(0, _styledComponents.css)(["list-style-type:none;margin:0;padding:0;"]);
